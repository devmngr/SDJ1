...

{
   ...
   private JLabel lblCustomer, lblFirstName, lblLastName, lblPhoneNr,
         lblLicenseNumber, lblStreet, lblNumber, lblPostalCode, lblCity;
   private JTextField txfFirstName, txfLastName, txfPhoneNr, txfLicenseNumber,
         txfStreet, txfNumber, txfPostalCode, txfCity, txfSearch;
    ...
    *           information
    */
   public BookRentalPanel(VehicleFileAdapter adapter, carRentalGuiAdapter gui,
   ...
   private class MyButtonListener implements ActionListener
   {
      ...
      public void actionPerformed(ActionEvent e)
      {
         if (e.getSource() == btnSearch)
         {
            ...
            txfBookingId.setText(rentalAdapter.getRentalList()
                  .getRentalByBookingID(bookingID).getID());
            txfVehicleType.setText(rentalAdapter.getRentalList()
                  .getRentalByBookingID(bookingID).getVehicle().getType());
            txfVehicleModel.setText(rentalAdapter.getRentalList()
                  .getRentalByBookingID(bookingID).getVehicle().getModel());
            txfVehicleNumberPlates.setText(rentalAdapter.getRentalList()
                  .getRentalByBookingID(bookingID).getVehicle()
                  .getNumberPlates());

            txfFirstName
                  .setText(rentalAdapter.getRentalList()
                        .getRentalByBookingID(bookingID).getCustomer()
                        .getFirstName());
            txfLastName.setText(rentalAdapter.getRentalList()
                  .getRentalByBookingID(bookingID).getCustomer().getLastName());

            String phone = rentalAdapter.getRentalList()
                  .getRentalByBookingID(bookingID).getCustomer()
                  .getPhoneNumber()
                  + "";
            txfPhoneNr.setText(phone);

            txfLicenseNumber.setText(rentalAdapter.getRentalList()
                  .getRentalByBookingID(bookingID).getCustomer()
                  .getDriverLicenseNumber());
            txfStreet.setText(rentalAdapter.getRentalList()
                  .getRentalByBookingID(bookingID).getCustomer().getStreet());
            txfNumber.setText(rentalAdapter.getRentalList()
                  .getRentalByBookingID(bookingID).getCustomer().getNumber());
            txfPostalCode.setText(rentalAdapter.getRentalList()
                  .getRentalByBookingID(bookingID).getCustomer()
                  .getPostalCode());
            txfCity.setText(rentalAdapter.getRentalList()
                  .getRentalByBookingID(bookingID).getCustomer().getCity());

            txfPickUpDate.setText(rentalAdapter.getRentalList()
                  .getRentalByBookingID(bookingID).getPickUpDate().getDate());
            txfPickUpTime.setText(rentalAdapter.getRentalList()
                  .getRentalByBookingID(bookingID).getPickUpDate().getTime());
            txfDeliveryDate.setText(rentalAdapter.getRentalList()
                  .getRentalByBookingID(bookingID).getDeliveryDate().getDate());
            txfDeliveryTime.setText(rentalAdapter.getRentalList()
                  .getRentalByBookingID(bookingID).getDeliveryDate().getTime());

            Rental rental = rentalAdapter.getRentalList().getRentalByBookingID(
                  bookingID);

            txfTotalDays.setText(rental.getPickUpDate().differenceBetweenDates(
                  rental.getDeliveryDate())
                  + " ");

            txfTotalPrice.setText(rentalAdapter.getRentalList()
                  .getRentalByBookingID(bookingID).getPrice()
                  + "");
