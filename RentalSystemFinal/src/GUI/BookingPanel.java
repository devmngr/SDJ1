...
/**
 * A user interface that allows to create a booking or reservation
 * 
...
public class BookingPanel extends JPanel
{
   ...
   private JLabel lblPickUp, lblPickUpDate, lblPickUpDate2, lblPickUpTime,
         ...
         lblDeliveryTime, lblDeliveryTime2, lblNumberOfDays, lblTotalPrice,
         lblPickUpLocation, lblDeliveryLocation;
   ...
   private JLabel lblCustomerDetails, lblFirstName, lblLastName, lblPhoneNr,
   ...
   /**
    * Sets bookig vehicle details on txfType field
    */
      ...
      public void actionPerformed(ActionEvent e)
      {
         if (e.getSource() == btnBook)
         {
            ...
            rental = new Rental(customer,
                  ...
                  gui.getSelectedVehicle(), txfPickUpLocation.getText(),
                  txfDeliveryLocation.getText(), gui.getTotalPrice());
            ...
            vehicleAdapter.changeStatusBooked(gui.getSelectedVehicle()
                  .getNumberPlates());
