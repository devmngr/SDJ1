...
public class VehicleFileAdapter
{
   ...
   // Use the MyFileIO class to retrieve a VehicleList object with all available
   // Vehicles
   ...
   // Use the MyFileIO class to retrieve a VehicleList object with all reserved
   // Vehicles
   ...
   // Use the MyFileIO class to retrieve a VehicleList object with all booked
   // Vehicles
   ...
   // //// Use the MyFileIO class to retrieve a VehicleList object with all
