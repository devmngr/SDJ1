   ...
   private class MyButtonListener implements ActionListener
   {
      ...
      public void actionPerformed(ActionEvent e)
      {
         if (e.getSource() == btnFinish)
         {
            ...
            customer = new Customer(txfFirstName.getText(), txfLastname.getText(), phoneNumber);
            rental = new Rental(customer, homePagePanel.getSelectedPickUpDates(), homePagePanel.getSelectedDeliveryDates(), gui.getSelectedVehicle(), 99999);
            rentalList = rentalAdapter.getRentalList();
            rentalList.addRental(rental);
            vehicleAdapter.changeStatusReserved(gui.getSelectedVehicle().getNumberPlates());
